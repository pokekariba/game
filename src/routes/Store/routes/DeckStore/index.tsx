...
const DeckStore: React.FC = () => {
  ...
  return (
    imagensCartas && (
      <div className="d-flex mx-5 store__deck-container">
        ...
        <div className="store_scrollbar d-flex flex-column align-center gap-5">
          <div className="store_scroll_container d-flex flex-column justify-center">
            {cartas.map((carta, idx) => (
              <div
                className="__store__card d-flex flex-column align-center"
                key={idx}
              >
                ...
                <div
                  onClick={() => setCartaVisivel(idx)}
                  className="store__card__thumb mb-5"
                >
